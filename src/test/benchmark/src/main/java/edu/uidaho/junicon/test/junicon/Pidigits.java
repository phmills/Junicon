...
public class Pidigits {
	...
	public static VariadicFunction Pidigits = (Object... args_1) -> {
		return new Pidigits();
	};
	// Methods
	...
	public static void main(String... args_9) {
		Pidigits c = new Pidigits(); VariadicFunction m = (VariadicFunction) c.main;
